        ...
        <Section sectionClassName="featured-cocktails">
            <div className="featured-cocktails__info">
                ...
                <p className="paragraph">
                    ...
                    refreshing zest of a Mojito, the sweet and tangy flavors of a Strawberry Margarita, or the smooth
                    balance of a classic Daiquiri, there's a drink here to delight every palate.
                </p>
            </div>
