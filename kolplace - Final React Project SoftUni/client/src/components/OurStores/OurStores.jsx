  ...
  return (
    <section className={styles["our-stores-section"]}>
      ...
      <div className={styles["info"]}>
        <p>
          Since 2020, our stores have been curating an extensive collection to
          bring you the latest trends in gadgets, fashion, books, and beyond.
          Immerse yourself in the joy of discovery as we strive to cater to your
          diverse tastes. Whether you&apos;re a tech enthusiast, a fashionista,
          or a bookworm, KolPlace stores are designed to elevate your shopping
          experience. Join us and indulge in a one-stop-shop where variety meets
