...
function HeroSection() {
    return (
        <Section sectionClassName="hero">
            <div className="hero">
                <div className="hero__text-box">
                    <h1 className="hero__heading">Discover the Ultimate Cocktail Experience</h1>
                    <p className="hero__info">
                        Crafting the finest cocktails for your delight. Every sip, a new story. Cheers to unforgettable
                        moments! Elevate your evenings with our masterfully crafted drinks.
                    </p>
